...
public class LogParser {
	...
	private static final String LOG_FILE_PATH="./../log_output/log.txt";
	private static final String STATUS_FILE_NAME="./../log_output/blocked.txt";
	private static final String HOURLY_REPORT_FILE_NAME="./../log_output/hours.txt";
	private static final String TOP_HOST_FILE_NAME="./../log_output/hosts.txt";
	private static final String TOP_RESOURCE_FILE_NAME="./../log_output/resource.txt";
